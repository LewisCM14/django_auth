...
class TestPermissionsDecorators:
    """Tests for per-view authorization decorators in api.permissions."""

    def test_authz_public_sets_public_policy(self) -> None:
    ...
    def test_authz_authenticated_sets_authenticated_policy(self) -> None:
        """authz_authenticated marks a view as requiring IIS auth only."""
    ...
    def test_authz_roles_sets_policy_and_roles(self) -> None:
